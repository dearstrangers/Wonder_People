...
describe "cleaners/approval_processes/new" do
  before(:each) do
    assign(:cleaners_approval_process, stub_model(Cleaners::ApprovalProcess,
  ...
  it "renders new cleaners_approval_process form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", cleaners_approval_processes_path, "post" do
