...
describe InterestsController do
  ...
  let(:valid_attributes) { { "interest_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved interest as @interest" do
        ...
        post :create, {:interest => { "interest_name" => "invalid value" }}, valid_session
        assigns(:interest).should be_a_new(Interest)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested interest" do
        ...
        Interest.any_instance.should_receive(:update).with({ "interest_name" => "MyString" })
        put :update, {:id => interest.to_param, :interest => { "interest_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the interest as @interest" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Interest.any_instance.stub(:save).and_return(false)
        put :update, {:id => interest.to_param, :interest => { "interest_name" => "invalid value" }}, valid_session
        assigns(:interest).should eq(interest)
      end
